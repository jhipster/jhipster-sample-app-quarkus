...
public class TokenProvider {
    ...
    final private long tokenValidityInMilliseconds;

    final private long tokenValidityInMillisecondsForRememberMe;
    ...
    public TokenProvider(JHipsterProperties jHipsterProperties) throws Exception {
        ...
        this.tokenValidityInMillisecondsForRememberMe = jHipsterProperties.security.authentication.jwt.tokenValidityInSecondsForRememberMe * 1000;
    }
